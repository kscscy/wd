...
public class Test04 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    ApplicationContext context = new ClassPathXmlApplicationContext("step01/application-context03.xml");

    System.out.println("bean의 이름 알아내기");
    for (String name : context.getBeanDefinitionNames()) {
      System.out.println(name);
    }

    System.out.println("특정 bean의 별명 알아내기");
    for (String alias : context.getAliases("c5")) {
      System.out.println(alias);
    }

    System.out.println("특정 type의 bean 이름 알아내기");
