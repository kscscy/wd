...
public class Test02 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    //
    // 출력 등급에 따른 출력 범위
    // TRACE > DEBUG > INFO > WARN > ERROR > FATAL (TRACE가 제일 큰 범위)
